...
public record ArtificeModelElementBuilderAdapter(
    ...
    public static record ArtificeRotationAdapter(
        com.swordglowsblue.artifice.api.builder.assets.ModelElementBuilder.Rotation rotation) implements ModelElementBuilder.Rotation {
    ...
    public static record ArtificeFaceAdapter(
        com.swordglowsblue.artifice.api.builder.assets.ModelElementBuilder.Face face) implements ModelElementBuilder.Face {
        @Override
